...
public class MainController implements Initializable {
    ...
    private Email emailTest2 = new Email("titi@gmail", "toto@gmail", "testMail", "Hellow wolrd ! it's a test");
    ...
    private Email emailTest6 = new Email("titi@gmail", "toto@gmail", "testMail", "Hellow wolrd ! it's a test");
    private Email emailTest7 = new Email("titi@gmail", "toto@gmail", "testMail", "Hellow wolrd ! it's a test");
    private Email emailTest8 = new Email("titi@gmail", "toto@gmail", "testMail", "Hellow wolrd ! it's a test");
